...
[FunctionTool]
static async Task<object?> ReadTextFile(string fileName, AgentContext context)
{
    try
    {
...
/// <param name="context">The agent context injected by the runtime</param>
[FunctionTool]
static async Task<object?> WriteTextFile(string fileName, string content, AgentContext context)
{
    try
    {
